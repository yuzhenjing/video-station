...
include "header.php";
if ($_GET["channel"]) {
	$link1 = "http://www.yunyouguo.com/zw/dsp/ysa.php?v=" . $_GET["channel"];
	$curl = curl_init();
	...
	curl_close($curl);
	$response = strstr($response, "<div class=\"song\"><a href=\"(.*?)\" target=\"_blank\" title=\"(.*?)\">
<span class=\"fa fa-film\"></span>(.*?)</a>");
	$response = strstr($response, "<div class=\"time\">", true);
...
<?php
		$sourl = "http://www.yunyouguo.com/zw/dsp/ysa.php?v=1";
