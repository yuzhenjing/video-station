...
<meta name="description" content="<?php echo $aik['title'];?>,微淘金，热剧快播,最好看的剧情片尽在<?php echo $aik['title'];?>,高清云影视免费为大家提供最新最全的免费电影，电视剧，综艺，动漫无广告在线云点播，以及电视直播">
	...
	<body>
		...
		<div class="wrap">
			...
			<div class="live_tip stat-div" id="msgerror" style="display: none;">
				...
				<div class="msg_lt">
					<p class="tit">直播结束</p>
					<p class="des">微淘金源码开源联系QQ:56146737</p>
				</div>	
			</div>
			<!-- 提示消息end -->
