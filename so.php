...
<title>影视资源 影片资源搜索-<?php echo $aik["sitename"];?>最新影视在线观看</title>
...
<meta name="keywords" content="<?php echo $wd;?>影片资源搜索，影视资源网，影视资源网采集，微淘金，智卓星网">
<meta name="description" content="<?php echo $aik["title"];?>-电影电视剧资源搜索，最新影视电视在线观看">
...
if ($_GET["sousuo"]) {
?>
<strong class="single-strong">影片视频资源搜索</strong><?php
	$url = "/s?q=" . $_GET["sousuo"] . "&p=" . $_GET["qiehuan"] . "";
	$ch = curl_init($url);
	...
	$response = str_replace("/ln?", "bdpango.php?", $response);
	$response = str_replace("", $aik["dtk_ad"], $response);
	echo $response;
	$a = "/s?q=" . $_GET["sousuo"] . "&p=" . $_GET["qiehuan"] . "";
	$curl = curl_init();
...
?><div id="homeso">
<form action="seacher.php" method="get" style="text-align: center;float: none" action="" >
<img src="images/wp.png"><br/><br/>
<input tabindex="2" class="homesoin" id="sos" name="sousuo" type="text" placeholder="输入你要搜索的影片名称" value="">

<button id="button" tabindex="3" class="homesobtn" type="submit">点击搜索</button>
</form>
</div>



<div class="single-strong">最新热门影片资源搜索</div><ul class="wprm"><b><?php
...
<div class="single-strong">关于搜索说明</div><ul class="wprm">
<font color="red">【提示】由于部分站外搜索资源不统一<p>搜索方法例如；可先直接输入影视片名的关键字（侏罗纪公园）或者输入带集数搜索（侏罗纪公园2）！<p>各种抢先影片、最新欧美、国内、日韩、福利视频，影视及电视剧资源在线搜索观看！
<br>注意：搜索出来的影片资源，下面显示的站外列表资源是采集搜索各大资源网影片，直接点击视频的播放列表即可在线观看，无需再次解析，站外搜索资源列表有各种抢先观看高清资源及各种影片、电视、其他福利视频等等，直接输入影片的关键字名称点击搜索即可！更多精彩资源请关注官方微信号或者添加官方QQ交流群。</font>
</ul></div>
</section>
