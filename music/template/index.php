...
<head>
    <meta charset="UTF-8">
    <title>音乐搜索器 - 多站合一音乐搜索,音乐在线试听 - 微淘金</title>
    ...
    <meta name="description" content="微淘金特制多站合一音乐搜索解决方案，可搜索试听网易云音乐、QQ音乐、酷狗音乐、酷我音乐、虾米音乐、百度音乐、一听音乐、咪咕音乐、荔枝FM、蜻蜓FM、喜马拉雅FM、全民K歌、5sing原创翻唱音乐。">
    ...
    <link rel="stylesheet" href="http://cdn.staticfile.org/amazeui/2.3.0/css/amazeui.min.css">
...
<body>
    ...
    <section class="am-g about">
        <div class="am-container am-margin-vertical-xl">
            <header class="am-padding-vertical">
                ...
                <p class="am-text-center">多站合一音乐搜索解析</p>
            </header>
            <hr>
    ...
    <footer class="footer">
        <p class="am-text-sm">v<?php echo MC_VERSION; ?>&nbsp;&copy;&nbsp;<?php echo date('Y'); ?>&nbsp;<a href="javascript:history.back()" target="_blank" rel="author">返回平台</a>&nbsp;<a href="https://dtmbw.com/" target="_blank">意见反馈</a>&nbsp;<a href="javascript:void(0)" data-am-modal="{target: '#copr-info'}">免责声明</a></p>
    </footer>
