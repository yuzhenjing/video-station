...
<p style="padding: 0 4px;">'; echo $aik['foot'];?><br/>管理员邮箱：<?php echo $aik['admin_email'];?><br/>&copy; 2017 <a href="<?php echo $aik['pcdomain'];?>"><?php echo $aik['sitename'];?><?='</a>&nbsp; <a href="https://www.weitaojin.cn/">'; echo $aik['icp'];?><?='</a>&nbsp; 
