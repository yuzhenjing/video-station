...
<meta name="description" content="源码开发请联系QQ号56146737-智卓星网开源">
...
<marquee id="madiv" behavior="scroll" direction="left"  align="Middle"  scrollamount="5"  onmouseover="this.stop();" onmouseout="this.start();">
...
<?php
		$sourl = "http://www.yunyouguo.com/zw/dsp/ysh.php?v=1";
...
?><b><a href="zhiysajx.php?v=<?php echo $zname[$key];?>"><li><?php echo $znama[$key];?>地区：<?php echo $link[$key];?></li></a></b>
<?php
		}
?></ul>
